    ...
    <div class="container">
      ...
      <div class="center"> <!-- content under Slider -->
        ...
        <div class="center-content"> <!-- type of menu -->
            <div class="center-subcontent"> <!-- pictire = main courses -->
              <a href="{{url('member/type/maincouse')}}">
            ...
            <div class="center-subcontent">
              <a href="{{url('member/type/Soup or Curry')}}">
      ...
      <div class="hidden-panel-content">
        <nav class="hidden-panel-nav">
          <h3>FOODS TU</h3>
          <ul>
            <li><a href="member/index" title="Home"><img src="pic/14.png"></a></li>
            <li>
                <?php
        ...
        @if($user)
                <div class="hidden-panel-text"> <!-- (2) User -->
                  ...
                  <br><a href="{{url('member/changepassworde/changepassworde')}}"><span>Change Password |</span></a>
